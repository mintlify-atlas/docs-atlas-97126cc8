---
title: "CRM: Patient Outreach and WhatsApp Campaigns"
sidebarTitle: "CRM"
description: "Select patients by status or search, then send individual WhatsApp messages or copy phone numbers to create a WhatsApp Business broadcast list for bulk outreach."
---
...
```
Hola *{name}*, le escribimos de *FemeSalud* para recordarle su cita médica
el día *{date}* a las *{time}* con *{doctor}*.
```
