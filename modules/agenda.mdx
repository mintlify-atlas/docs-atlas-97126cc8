...
<CardGroup cols={2}>
  <Card title="Day View" icon="calendar-day" href="/modules/agenda">
  ...
  <Card title="Week View" icon="calendar-range" href="/modules/agenda">
  ...
  <Card title="Month View" icon="calendar" href="/modules/agenda">
  ...
  <Card title="List View" icon="list" href="/modules/agenda">
...
<CardGroup cols={3}>
  <Card title="programada" icon="clock" href="/modules/agenda">
    Scheduled — appointment is upcoming and confirmed. Displayed in purple (mauve) across all views.
  </Card>
  <Card title="completada" icon="circle-check" href="/modules/agenda">
  ...
  <Card title="cancelada" icon="circle-x" href="/modules/agenda">
