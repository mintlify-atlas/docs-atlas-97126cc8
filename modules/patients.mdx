...
<CardGroup cols={2}>
  <Card title="nuevo" icon="sparkles">
...
<CardGroup cols={2}>
  <Card title="Ficha Médica" icon="file-medical">
  ...
  <Card title="Historia Clínica Completa" icon="clipboard">
