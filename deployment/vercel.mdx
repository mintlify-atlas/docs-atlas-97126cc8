---
title: "Deploy FemeSalud to Vercel with TanStack Start and Nitro"
sidebarTitle: "Vercel"
description: "Deploy FemeSalud to Vercel with TanStack Start. Set Supabase variables and build SSR serverless functions with the Nitro Vercel preset in seconds."
---
...
<Steps>
  <Step title="All five environment variables are set in Vercel">
