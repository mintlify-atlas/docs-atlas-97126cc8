...
description: "Field reference for the appointments table including scheduling fields, payment information, status values, and the AppointmentFilters interface for querying."
---
