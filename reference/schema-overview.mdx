...
description: "FemeSalud uses a PostgreSQL database on Supabase with 10 tables, 2 enums, Row Level Security, and 2 database functions. Review all tables and their relationships here."
---
...
<CardGroup cols={2}>
  ...
  <Card title="profiles" icon="id-card">
    Doctor and admin user profiles. Extends `auth.users` with display name, specialty, and professional registration numbers (MPPS, CMC).
  </Card>
